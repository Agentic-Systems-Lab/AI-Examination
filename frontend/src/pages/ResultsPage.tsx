...
function ResultsPage() {
  ...
  const handleSurveySubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await examAPI.submitSurvey(surveysToSubmit)
                ...
                <div className="flex gap-4">
                  {[1, 2, 3, 4, 5].map((rating) => (
                    <button
                      ...
                      className={`w-10 h-10 rounded-full flex items-center justify-center border ${fairness === rating
                        ? 'bg-blue-600 text-white border-blue-600'
                        : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'
                        }`}
                    >
                ...
                <div className="flex gap-4">
                  {[1, 2, 3, 4, 5].map((rating) => (
                    <button
                      ...
                      className={`w-10 h-10 rounded-full flex items-center justify-center border ${aiAccuracy === rating
                        ? 'bg-blue-600 text-white border-blue-600'
                        : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'
                        }`}
                    >
